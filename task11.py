...
def run(run_index, iteration_index, input, output, user_programs):
    ...
    tests = [('5-66666', []),
             ('5-9999', ['impulseA']), ('88888-77777-666666', ['impulseA', 'impulseA', 'impulseA'])]
    log = ''
...
if __name__ == "__main__":
    print(run(0, 0, 0, 0, ['''state_machine = \'\'\'<?xml version="1.0" encoding="UTF-8"?>
...
lapkiVisual/ true
    ...
    <node id="fqpyxhnilqzsdoqiqhdc">
      <data key="dName">Счет</data>
...
Reader1.read()
      ...
      <data key="dGeometry">
        <rect x="627" y="683" width="450" height="100"></rect>
      </data>
    </node>
    <node id="eztajilgwlkhsyuvxkkc">
      <data key="dVertex">initial</data>
      <data key="dGeometry">
        <point x="569" y="563"></point>
      </data>
    </node>
    <node id="phqmpjuqfufkbhyfclqf">
      <data key="dVertex">final</data>
      <data key="dGeometry">
        <point x="859" y="1165"></point>
      </data>
    </node>
    <node id="fssmjkwmchcjqnmpzqdf">
      <data key="dVertex">final</data>
      <data key="dGeometry">
        <point x="658" y="1171"></point>
      </data>
    </node>
    <node id="hjveqyzuqiltnzlfphnz">
      <data key="dVertex">choice</data>
      <data key="dGeometry">
        <point x="1541" y="801"></point>
      </data>
    </node>
    <node id="cReader1">
      <data key="dNote">formal</data>
...
name/ Сумма
    ...
    <edge id="vbcdxtmgkwgozvwktehv" source="eztajilgwlkhsyuvxkkc" target="fqpyxhnilqzsdoqiqhdc"></edge>
    <edge id="gecxoyolgzikkhnxetqh" source="fqpyxhnilqzsdoqiqhdc" target="hjveqyzuqiltnzlfphnz">
      <data key="dData">Reader1.char_accepted[Reader1.current_char == -]/

</data>
      <data key="dLabelGeometry">
        <point x="1181" y="812"></point>
      </data>
    </edge>
    <edge id="spconailimglbvhpitdh" source="hjveqyzuqiltnzlfphnz" target="fqpyxhnilqzsdoqiqhdc">
      <data key="dData">[Counter1.value &gt; 33]/
Impulse1.impulseA()

</data>
      <data key="dLabelGeometry">
        <point x="1525.5" y="669"></point>
      </data>
    </edge>
    <edge id="kdnovckfselpokapljek" source="hjveqyzuqiltnzlfphnz" target="fqpyxhnilqzsdoqiqhdc">
      <data key="dData">[else]/

</data>
      <data key="dLabelGeometry">
        <point x="1524.5" y="1007"></point>
      </data>
    </edge>
    <edge id="econyzcwxtwhpksyowou" source="fqpyxhnilqzsdoqiqhdc" target="phqmpjuqfufkbhyfclqf">
      <data key="dData">Reader1.line_finished[Counter1.value &gt; 33]/
Impulse1.impulseA()

</data>
      <data key="dLabelGeometry">
        <point x="832" y="1023"></point>
      </data>
    </edge>
    <edge id="pqbngssieyiqpgujmmwx" source="fqpyxhnilqzsdoqiqhdc" target="fssmjkwmchcjqnmpzqdf">
      <data key="dData">Reader1.line_finished[else]/

</data>
      <data key="dLabelGeometry">
        <point x="607.5" y="1022"></point>
      </data>
    </edge>
  </graph>
</graphml>
